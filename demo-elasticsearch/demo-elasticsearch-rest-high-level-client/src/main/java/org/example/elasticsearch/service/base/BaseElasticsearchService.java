package org.example.elasticsearch.service.base;
...
import org.example.elasticsearch.config.ElasticsearchProperties;
import org.example.elasticsearch.exception.ElasticsearchException;
    ...
    protected void createIndexRequest(String index) {
        try {
            ...
            request.settings(Settings.builder().
                    put("index.number_of_shards", elasticsearchProperties.getIndex().getNumberOfShards()).put("index.number_of_replicas", elasticsearchProperties.getIndex().getNumberOfReplicas()));
